...
const ZH_CN: &[(&str, &str)] = &[
    ...
    // 邮件 HTML 美化（带 ReportMeta）
    ("email.html.meta_title", "本期概览"),
    ("email.html.stat.projects", "项目数"),
    ("email.html.stat.tokens", "Tokens"),
    ("email.html.stat.llm", "LLM 源"),
    ("email.html.stat.generated", "生成时间"),
    ("email.html.chart_title", "按项目工作量"),
];
...
const EN: &[(&str, &str)] = &[
    ...
    // 邮件 HTML 美化（带 ReportMeta）
    ("email.html.meta_title", "This period"),
    ("email.html.stat.projects", "Projects"),
    ("email.html.stat.tokens", "Tokens"),
    ("email.html.stat.llm", "LLM"),
    ("email.html.stat.generated", "Generated"),
    ("email.html.chart_title", "Work by project"),
];
